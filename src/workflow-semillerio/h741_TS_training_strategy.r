...
PARAM <- list()
PARAM$experimento <- "AH7410"

PARAM$exp_input <- "AH7310"
...
PARAM$train$training <- c(
  202104, 202101, 202012, 202011, 202010,
  202009, 202001, 201912, 201911, 201910, 201909, 201908,
  201907, 201906, 201905, 201904, 201903
)

PARAM$train$validation <- c(202102)
PARAM$train$testing <- c(202106, 202105, 202103)
