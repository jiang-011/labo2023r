...
PARAM <- list()
PARAM$experimento <- "AC7410"

PARAM$exp_input <- "AB7310"
...
PARAM$final_train <- c(
  ...
  202103, 202102, 202101, 202012, 202011, 202010, 202009, 202001, 201912,
  201911, 201910, 201909
)

PARAM$train$training <- c(
  202106, 202104, 202101, 202012, 
  202011, 202010, 202009, 202001, 201912, 201911, 201910, 201909, 201908,
